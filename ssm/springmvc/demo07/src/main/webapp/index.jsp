...
<div>
	   ...
	   <div class="container">
		  ...
		  <div class="logo_right">
		  	 <nav class="nav">
				   ...
				   <ul>
					<li><a href="denglu.jsp" class="active">登录</a></li>
				   </ul>
		  	 </nav>
		  	 <div class="search">
		  	 	<span class="sea_x">
	...
	<section class="banner">
	    <div><a href="index.jsp"><img src="images/banner1.jpg" alt=""></a></div>
	    <div><a href="index.jsp"><img src="images/222.jpg" alt=""></a></div>
	    <div><a href="index.jsp"><img src="images/333.jpg" alt=""></a></div>
	</section>
	<!--banner end-->
	<div class="jqgk">
		<div class="contai">
			...
			<p class="wow bounceIn">
				湖南明日民宿管理位于衡阳衡山科学城，是专注于精品民宿的创业连锁平台。<br />
公司成立于2020年11月11日，注册资金xxxx万元。明日使命在于构筑“万众创新、大众创业”的新型平台，建立一个为历史和未来负责的、“留得住浓浓的乡愁”的城镇化村落服务体系，<br />
